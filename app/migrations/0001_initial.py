# Generated by Django 4.2.5 on 2024-02-24 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='units/default.jpg', upload_to='units', verbose_name='Фото')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('debt', models.IntegerField(null=True, verbose_name='Задолженность')),
                ('status', models.IntegerField(choices=[(1, 'Введён'), (2, 'В работе'), (3, 'Завершен'), (4, 'Отклонен'), (5, 'Удален')], default=1, verbose_name='Статус')),
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 2, 24, 17, 12, 53, 712060, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('units', models.ManyToManyField(null=True, to='app.unit', verbose_name='Виды рассчёта')),
            ],
            options={
