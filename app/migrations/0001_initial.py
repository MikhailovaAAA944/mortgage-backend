    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='units/default.png', upload_to='units', verbose_name='Фото')),
            ],
            options={
                'verbose_name': 'Места',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.ManyToManyField(null=True, to='app.unit', verbose_name='Продукты')),
            ],
            options={
                'verbose_name': 'Заявка',
