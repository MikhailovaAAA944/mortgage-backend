...
class Unit(models.Model):
    ...
    image = models.ImageField(upload_to="units", default="units/default.jpg", verbose_name="Фото")

    def __str__(self):
        return self.name

    class Meta:
        verbose_name = "Вид рассчёта"
        verbose_name_plural = "Виды рассчёта"
        db_table = "units"
...
class Calculation(models.Model):
    ...
    units = models.ManyToManyField(Unit, verbose_name="Виды рассчёта", null=True)
    debt = models.IntegerField(verbose_name="Задолженность", null=True)
    ...
    def __str__(self):
        return "Рассчёт №" + str(self.pk)

    class Meta:
        verbose_name = "Рассчёт"
        verbose_name_plural = "Рассчёты"
